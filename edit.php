...
<body>
    <div class=" my-5 edit">
        <h2 class="d-flex justify-content-center judul">Edit Siswa</h2>
        ...
        <form method="post ">
            ...
            ?>
            <div class="row mb-3 tombol d-flex justify-content-center">
                <div class=" col-sm-5 d-grid">
                    <button type="submit" class="btn btn-primary ngumpulin">Submit</button>
                </div>
                <div class="col-sm-5 d-grid">
